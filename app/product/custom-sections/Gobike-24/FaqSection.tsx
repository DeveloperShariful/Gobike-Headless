...
const faqData = [
  ...
  { question: "How long does the battery last on a single charge?", answer: "The 48-55V 10Ah battery provides a run time of approximately range of up to 3 hours, depending entirely on the terrain, speed mode, and rider weight." },
