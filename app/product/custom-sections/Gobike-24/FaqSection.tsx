...
const faqData = [
  ...
  { question: "How fast does the 1500W motor go?", answer: "The powerful 1500W brushless motor delivers a top speed of 31 mph (50 km/h) in Sport Mode. It also features Low (17km/h) and Medium (35km/h) modes for different skill levels." },
  ...
  { question: "How long does the battery last on a single charge?", answer: "The 48V 10Ah battery provides a run time of approximately 60-90 minutes or a range of 15-30km, depending entirely on the terrain, speed mode, and rider weight." },
