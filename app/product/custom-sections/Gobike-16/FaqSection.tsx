...
const faqData = [
  ...
  { question: "What kind of maintenance does the GoBike 16 require?", answer: "It's designed to be low-maintenance. We recommend regular checks on tire pressure, brake function, and keeping the chain clean and lubricated, similar to any quality bicycle." },
