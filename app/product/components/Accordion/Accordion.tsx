...
// import styles from './Accordion.module.css'; // CSS Module সরানো হয়েছে
  ...
  return (
    ...
    <div className="w-full max-w-[800px] mx-auto">
      {items.map((item, index) => (
        // .accordionItem replaced
        <div key={index} className="border-b border-gray-200">
          <button
            // .accordionQuestion replaced
          ...
          >
            ...
            {/* .arrow & .arrowOpen logic replaced */}
            <span 
          ...
          {/* .accordionAnswer & .answerOpen logic replaced */}
          <div 
