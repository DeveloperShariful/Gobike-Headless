...
const items = [
    { name: 'GoBike 12" E-Bike Frame', img: 'https://gobikes.au/wp-content/uploads/2025/02/12inch-1.webp' },
    { name: '1 Handlebar', img: 'https://gobikes.au/wp-content/uploads/2025/02/1734722319249-scaled-1-1.webp' },
