...
const specs = [
  { label: 'What\'s in the Box', value: '1 x GoBike 20 Inch E-Bike' }, // "Bike"
  { label: 'Battery Included', value: '1 x Industrial-grade waterproof 36V-42V 10Ah lithium-ion battery' }, // "Battery"
