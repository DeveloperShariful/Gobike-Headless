...
// ⚠️ খুব জরুরি: বামপাশের নামগুলো (যেমন 'battery', 'tyre') আপনার ওয়েবসাইটের URL এর স্লাগের সাথে হুবহু মিলতে হবে! 
// যদি আপনার URL হয় /electric-bike-parts/tyres, তবে এখানে 'tyre' এর বদলে 'tyres' লিখতে হবে।

export const seoContentMap: Record<string, any> = {
    'battery': {
      topIntro: `Showcase replacement and upgrade electric bike batteries built specifically for the GoBike 12, 16, 20 and 24 inch range, with reliable lithium-ion cells, long ride times and safe charging. View our full range of <a href="/bikes" class="text-blue-600 font-medium hover:underline">kids electric bikes</a> to find the perfect match.`,
      bottomSections: [
        {
    ...
    'tyre-tube': {
      topIntro: `Position GoBike as the place to find replacement and upgrade electric bike tyres for 12, 16, 20 and 24 inch electric bikes. Ensure your child rides safely on all terrains. Discover our full collection of <a href="/bikes" class="text-blue-600 font-medium hover:underline">bikes</a> today.`,
      bottomSections: [
        {
    ...
    'motors-components': {
      topIntro: `Showcase replacement and upgrade electric bike motors and motor kits engineered for the GoBike range, from the entry-level GoBike 12 right through to the powerful 2500W GoBike 24. Explore our complete range of <a href="/bikes" class="text-blue-600 font-medium hover:underline">electric bikes</a>.`,
      bottomSections: [
        {
